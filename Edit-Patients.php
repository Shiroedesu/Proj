...
if (isset($_POST['submit'])) {
    ...
    $update_folder = 'patients_image/'.$update_pic;
    ...
    <body>
        ...
        <div class="container">
            ...
            <?php
                    ...
                    ?>
            <div class="main">
                <h1 class="heading">EDIT <span>PERSONAL</span> RECORD </h1>
                    <a href="View_patients.php? id=<?php echo $row['id'];?>" class="back">Back</a>
                <br></br>
                <br></br>
