...
if (isset($_POST['submit'])) {
      $updated_givenname = $_POST['update_givenname'];
      $updated_lastname = $_POST['update_lastname'];
      $updated_middlename = $_POST['update_middlename'];
      $updated_dob = $_POST['update_dob'];
      $updated_place_of_birth = $_POST['update_place_of_birth'];
      $updated_address = $_POST['update_address'];
      $updated_religion = $_POST['update_religion'];
      $updated_nationality = $_POST['update_nationality'];
      $updated_height = $_POST['update_height'];
      $updated_weight = $_POST['update_weight'];
      $updated_birth_ref_no = $_POST['update_birth_ref_no'];
      $updated_house_no = $_POST['update_house_no'];
      $updated_line_no = $_POST['update_line_no'];
      $updated_family_no = $_POST['update_family_no'];
      $updated_bloodtype = $_POST['update_bloodtype'];
      $updated_gender = $_POST['update_gender'];
      $updated_civilstatus = $_POST['update_civilstatus'];
      $updated_id = $_POST['update_id'];
      $updated_age = $_POST['update_age'];
      $others = $_POST['others'];
      $updated_form1 = implode(',', $_POST['form1']);
    $updated_form2 = implode(',', $_POST['form2']);

    $sql = "UPDATE patients SET givenname = '$updated_givenname', lastname = '$updated_lastname', middlename = '$updated_middlename', dob = '$updated_dob', place_of_birth = '$updated_place_of_birth', address = '$updated_address', religion = '$updated_religion', nationality = '$updated_nationality', height = '$updated_height', weight = '$updated_weight', birth_ref_no = '$updated_birth_ref_no', house_no = '$updated_house_no', line_no = '$updated_line_no', family_no = '$updated_family_no', blood_type = '$updated_bloodtype', gender = '$updated_gender', civilstatus = '$updated_civilstatus', form1 = '$updated_form1', form2 = '$updated_form2', age = '$updated_age' , others = '$others' WHERE id = '$updated_id'" or die ('query failed!');
    ...
    $update_pic = $_FILES['update_img']['name'];
    $update_file_size = $_FILES['update_img']['size'];
    $update_tmp_name = $_FILES['update_img']['tmp_name'];
    $update_folder = 'uploaded_img/'.$update_pic;

    if(!empty($update_pic)){
      if($update_file_size > 2000000){
        $message[] = 'Image size is too large!';
      }else {
        $updated_pic = mysqli_query($conn, "UPDATE patients SET image = '$update_pic' WHERE id = '$id'") or die ('query failed!');
          if($updated_pic){
...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="user_assets/css/Add-Patients_now.css">
    ...
    <body>
        ...
        <header class="header">
            ...
            <img class="img" src="assets/imgs/flogo.png"><a
                class="health"><strong>Health </strong>Information System </a>
        ...
        <div class="container">
            ...
            <div class="main">
                <?php
                       ...
                       ?>
                <h1 class="heading">EDIT <span>PATIENT</span> DATA </h1>
                    <a href="user_view_patients.php? id=<?php echo $row['id'];?>" class="back">Back</a>
                <br></br>
                <br></br>
                    <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form">
                            ...
                            <h1 class="heading"> <span>PATIENT</span> DATA </h1>
                            <div class="form1">
                                ...
                                <table class="fillup">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td id="blank"><p>Frequent Cold / Sore Throat</p></td>
