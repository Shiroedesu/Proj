...
<html lang="en">
    ...
    <body>
        ...
        <div class="container">
            ...
            <!-- ========================= Main ==================== -->
            <div class="main">
                <h1 class="heading"> <span>LIST</span> PATIENTS </h1>
                <div class="data">
                        <div class="inputs">
                            <div>
                                <input type="search" id="search" placeholder="Find Patient"></input>
                                <a class="addPatient" href="Add-Patients.php">Add Patient</a>
                            </div>
                        </div>
                <table class="table">
                            <thead>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="View_patients.php? id=<?php echo $row['id'];?>" class="edit">View</a></td>               
                                    </tr>
                                    <?php
                                        }
                                    ?>
