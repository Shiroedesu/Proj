                    ...
                    <form action="#" method="post" enctype="multipart/form-data">
                        <div class="form">
                                        ...
                                        <table class="table3">
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input type="text" name="birth_ref_no" ></td>
                                                </tr>
                                                <tr>
                                                    <td>Household No.</td>
                                                ...
                                                <tr>
                                                    <td>Line No.</td>
                                                    <td><input type="text" name="line_no" ></td>
                                                </tr>
                                                <tr>
                                                    <td>Family No.</td>
                                                    <td><input type="text" name="family_no" ></td>
                                                </tr>
                                                <tr>
                                                    <td>Blood Type:</td>
                                        ...
                                        <table>
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td id="dt"><input type="text" name="lastname" ></td>
                                                </tr>
                                                <tr>
                                                    <td id="dt">GIVEN NAME:</td>
                                                    <td id="dt"><input type="text" name="givenname" ></td>
                                                </tr>
                                                <tr>
                                                    <td id="dt">MIDDLE NAME:</td>
                                                    <td id="dt"><input type="text" name="middlename" ></td>
                                                </tr>
                                                <tr>
                                                    <td id="dt">DATE OF BIRTH:</td>
                                                    <td id="dt"><input type="date" name="dob" ></td>
                                                </tr>
                                                <tr>
                                                    <td id="dt">AGE:</td>
                                                    <td id="dt"><input type="text" name="age" ></td>
                                                </tr>
                                                <tr>
                                                    <td id="dt">PLACE OF BIRTH:</td>
                                                    <td id="dt"><input type="text" name="place_of_birth" ></td>
                                                </tr>
                                                <tr>
                                                    <td id="dt">ADDRESS:</td>
                                                    <td id="dt"><input type="text" name="address" ></td>
                                                </tr>
                                            </tbody>
                                        </table>
                                        <br>
                                        <table class="table2">
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td id="dt2"><input type="text" name="religion" ></td>
                                                    <td id="dt2">Nationality:</td>
                                                    <td id="dt2"><input type="text" name="nationality" ></td>
                                                </tr>
                                                <tr>
                                                    <td id="dt3">Gender:</td>
                                                    <td id="dt3"><input type="radio" name="gender" value="Male">
                                                    <label>Male</label>
                                                    <input type="radio" name="gender" value="Female">
                                                    <label>Female</label>
                                                    </td>
                                                    <td id="dt3">Height:</td>
                                                    <td id="dt3"><input type="text" placeholder="cm" name="height" ></td>
                                                </tr>
                                                <tr>
                                                    <td id="dt3">Civil Status:</td>
                                                    <td id="dt3"><input type="radio" name="status" value="Single">
                                                    <label>Single</label>
                                                    <input type="radio" name="status" value="Married">
                                                    <label>Married</label>
                                                    </td>
                                                    <td id="dt3">Weight:</td>
                                                    <td id="dt3"><input type="text" placeholder="kg" name="weight" ></td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
                            ...
                            <div class="form1">
                                ...
                                <div class="form1"> 
                                <h4>OTHERS</h4>
                                <input type="text" name="" style="width:100%; padding: 10px 10px 30px 10px;border: 1px solid; margin: 0px 200px; font-size: 18px; background-color: #f4f4f4; border-radius: 8px;">
                            </div>
